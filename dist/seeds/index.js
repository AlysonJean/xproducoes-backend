...
async function main() {
    ...
    const client1 = await prisma_1.prisma.user.upsert({
    ...
    const client2 = await prisma_1.prisma.user.upsert({
    ...
    const collaborator1 = await prisma_1.prisma.user.upsert({
    ...
    const collaborator2 = await prisma_1.prisma.user.upsert({
    ...
    const anaCollaborator = await prisma_1.prisma.collaborator.upsert({
    ...
    const pedroCollaborator = await prisma_1.prisma.collaborator.upsert({
    ...
    const catFotografia = await prisma_1.prisma.category.upsert({
    ...
    const catAudiovisual = await prisma_1.prisma.category.upsert({
    ...
    const catIluminacao = await prisma_1.prisma.category.upsert({
    ...
    const catSonorizacao = await prisma_1.prisma.category.upsert({
    ...
    const catDecoracao = await prisma_1.prisma.category.upsert({
    ...
    // Fotografia
    const canonR6 = await prisma_1.prisma.equipment.upsert({
    ...
    const sonyA7IV = await prisma_1.prisma.equipment.upsert({
    ...
    // Lentes
    await prisma_1.prisma.equipment.upsert({
    ...
    // Audiovisual
    const sonyFX3 = await prisma_1.prisma.equipment.upsert({
    ...
    const kitCasamento = await prisma_1.prisma.kit.create({
        data: {
    ...
    const kitCorporativo = await prisma_1.prisma.kit.create({
        data: {
    ...
    await prisma_1.prisma.portfolio.upsert({
    ...
    const booking1 = await prisma_1.prisma.booking.create({
        data: {
    ...
    await prisma_1.prisma.faq.upsert({
        where: { id: "faq-1" },
        update: {},
        create: {
            id: "faq-1",
