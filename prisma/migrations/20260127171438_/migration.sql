...
-- CreateEnum
CREATE TYPE "public"."ChatType" AS ENUM ('PRIVATE', 'GROUP', 'EVENT', 'SUPPORT');

-- CreateEnum
CREATE TYPE "public"."ChatRole" AS ENUM ('ADMIN', 'MODERATOR', 'MEMBER');

-- CreateEnum
CREATE TYPE "public"."ChecklistType" AS ENUM ('GENERAL', 'EVENT_SETUP', 'EVENT_BREAKDOWN', 'MAINTENANCE', 'CLIENT_MEETING', 'DELIVERY', 'PICKUP', 'OTHER');

-- CreateEnum
CREATE TYPE "public"."ChecklistStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'ARCHIVED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "public"."ChecklistItemStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED', 'SKIPPED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "public"."ChecklistPriority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'URGENT');

-- CreateEnum
CREATE TYPE "public"."ChecklistAssignmentStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED', 'OVERDUE', 'CANCELLED');
...
CREATE TABLE "public"."checklists" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT,
    "type" "public"."ChecklistType" NOT NULL DEFAULT 'GENERAL',
    "status" "public"."ChecklistStatus" NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE "public"."checklist_assignments" (
    ...
    "status" "public"."ChecklistAssignmentStatus" NOT NULL DEFAULT 'PENDING',
    "notes" TEXT,
    "completedAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "public"."app_settings" (
    "id" TEXT NOT NULL,
    "logoUrl" TEXT,
    "companyName" TEXT NOT NULL DEFAULT 'X Produçoes e Eventos',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "chat_message_reads_messageId_userId_key" ON "public"."chat_message_reads"("messageId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "checklist_assignments_checklistId_assignedToId_key" ON "public"."checklist_assignments"("checklistId", "assignedToId");
...
-- AddForeignKey
ALTER TABLE "public"."chat_message_reads" ADD CONSTRAINT "chat_message_reads_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "public"."chat_messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."chat_message_reads" ADD CONSTRAINT "chat_message_reads_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."checklists" ADD CONSTRAINT "checklists_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."checklist_items" ADD CONSTRAINT "checklist_items_completedById_fkey" FOREIGN KEY ("completedById") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."checklist_assignments" ADD CONSTRAINT "checklist_assignments_checklistId_fkey" FOREIGN KEY ("checklistId") REFERENCES "public"."checklists"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."checklist_assignments" ADD CONSTRAINT "checklist_assignments_assignedToId_fkey" FOREIGN KEY ("assignedToId") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."checklist_assignments" ADD CONSTRAINT "checklist_assignments_assignedById_fkey" FOREIGN KEY ("assignedById") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
